  ...
  try {
    ...
    await Promise.all([
      ...
      writeFile(
        ...
        [
          'import type { PublisherNextErrorIdentity } from "@genii-foundation/publisher-next/client";',
          "",
          `export const publisherErrorIdentity = Object.freeze(${JSON.stringify(errorIdentity, null, 2)} as const) satisfies PublisherNextErrorIdentity;`,
          "",
        ].join("\n"),
        "utf8",
      ),
      writeFile(
        ...
        [
          ...
          'import { PublisherNextErrorPage, PublisherNextFrameworkErrorPage, PublisherNextGlobalErrorPage, type PublisherNextErrorIdentity } from "@genii-foundation/publisher-next/client";',
